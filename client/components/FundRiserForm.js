...
const FundRiserForm = () => {
    ...
    const charityFundingContract = useSelector(state=>state.fundingReducer.contract)
    ...
    const riseFund = (e) =>{
       ...
       startFundRaising(web3,charityFundingContract,data,onSuccess,onError,dispatch)
    }

  return (
    <>
        <h1 className="font-sans font-bold text-xl">Start a fundraising for free</h1>
