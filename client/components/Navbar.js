        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                      <h4 className='font-mono text-xl text-greay font-bold hidden lg:block'>FUNDARITY</h4>
                </div>
                ...
                <div className="flex space-x-4">
                    ...
                    <Link href="/projects"><span className={`${router.pathname === "/projects"?"bg-[#F7C984]":""} text-greay px-3 py-2 rounded-md text-sm font-medium hover:cursor-pointer hover:bg-[#F7C984] hover:text-greay`}>Project Explore</span></Link>
                </div>
                </div>
            </div>
